...
set :default_environment, {
  ...
  'PATH'      =>  '/home/ubuntu/.rvm/gems/ruby-1.9.3-p0@AceGmr/bin:/home/ubuntu/.rvm/gems/ruby-1.9.3-p0@global/bin:/home/ubuntu/.rvm/rubies/ruby-1.9.3-p0/bin:/home/ubuntu/.rvm/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games',
  'GEM_PATH'  =>  '/home/ubuntu/.rvm/gems/ruby-1.9.3-p0@AceGmr:/home/ubuntu/.rvm/gems/ruby-1.9.3-p0@global',
  'GEM_HOME'  =>  '/home/ubuntu/.rvm/gems/ruby-1.9.3-p0@AceGmr',
...
set :application, "AceGmr"
set :repository,  "git@github.com:MarcinRKL/AceGmr.git"
# set :branch, "staging"
...
namespace :deploy do
  ...
  LocalSharePath = File.join(`echo $SNOZZBERRYLABS`.strip, 'SHARED', 'AceGmr').to_s
  ...
  task :symlink do
    ...
    # run "ln -nfs #{shared_path}/config/keys/production/facebook.yml #{release_path}/config/keys/production/facebook.yml"
    # run "ln -nfs #{shared_path}/config/keys/production/aws-s3.yml #{release_path}/config/keys/production/aws-s3.yml"
